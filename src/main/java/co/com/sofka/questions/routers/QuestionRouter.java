...
public class QuestionRouter {
                    ...
                    @RouterOperation(path = "/getAll", produces = {MediaType.APPLICATION_JSON_VALUE},
                            ...
                            operation = @Operation(operationId = "getAllQuestions",
                                    responses = {
                                            ...
                                            @ApiResponse(responseCode = "500", description = "Error de servidor interno"),
                                            @ApiResponse(responseCode = "400", description = "Solicitud invalidad"),
                                            @ApiResponse(responseCode = "404", description = "Valor no encontrado")},
                                    parameters = {
    ...
    RouterFunction<ServerResponse> routerFunction(ListUseCase listUseCase, AddAnswerUseCase addAnswerUseCase, GetUseCase getUseCase, CreateUseCase createUseCase, DeleteUseCase deleteUseCase,
